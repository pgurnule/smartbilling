...
public class UsersDetails extends DialogFragment {
    String TAG = DiscountDialog.class.getName();
    Activity activity;
    LayoutInflater inflater;
    private AlertDialog d;

    public static UsersDetails getInstance(String someArgument) {
        UsersDetails appCompatMaterialAlertDialog = new UsersDetails();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.layout_user_details, null);
        initDialogUi(v);
